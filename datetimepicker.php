					...
					<div id="" class="col-md-9 partbox-header-informations">
						<div id="" class="row">
							...
							<div id="" class="col-md-12 partbox-header-title">
								...
								<span class="partbox-header-title-text">DATE & TIME PICKER</span>
							</div>
										...
										<div id="" class="row">
												...
												<div id="" class="row">
													...
													<div id="" class="col-md-9 form-group-header-informations">
														<div id="" class="row">
															...
															<div id="" class="col-md-12 form-group-header-title">
																<span class="form-group-header-title-text">DATE PICKER</span>
															</div>
											...
											<div id="" class="col-md-12 form-group-body">
												<div id="" class="row">
													...
													<!-- form item start -->
													<div id="datePicker" class="col-md-12 form-item">
														<div id="" class="row">
										...
										<div id="" class="row">
												...
												<div id="" class="row">
													...
													<div id="" class="col-md-9 form-group-header-informations">
														<div id="" class="row">
															...
															<div id="" class="col-md-12 form-group-header-title">
																<span class="form-group-header-title-text">DATE & TIME PICKER</span>
															</div>
											...
											<div id="" class="col-md-12 form-group-body">
												<div id="" class="row">
													...
													<!-- form item start -->
													<div id="dateTimePicker" class="col-md-12 form-item">
														<div id="" class="row">
...
<script src="js/plugins/datepicker/js/datepicker.js"></script>
<!-- external scripts end -->
<!-- internal scripts start -->
<script src="js/content/datetimepicker.js"></script>
