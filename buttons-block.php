					...
					<div id="" class="col-md-9 partbox-header-informations">
						<div id="" class="row">
							...
							<div id="" class="col-md-12 partbox-header-title">
								<i class="fa fa-minus partbox-header-title-icon"></i>
								<span class="partbox-header-title-text">BUTTONS - BLOCK</span>
							</div>
														...
														<div id="" class="box-invisible">
															<div id="" class="row ">
																...
																<div id="" class="col-md-12 info-content-body">
																	...
																	<p class="info-content-text"><span class="highlight">.btn.btn-block</span></p>
																</div>
												...
												<div id="" class="row">
													...
													<div id="" class="col-md-9 form-group-header-informations">
														<div id="" class="row">
															...
															<div id="" class="col-md-12 form-group-header-title">
																<span class="form-group-header-title-text">BUTTONS - BLOCK</span>
															</div>
											...
											<div id="" class="col-md-12 form-group-body">
												<div id="" class="row">
													...
													<div id="" class="col-md-12 form-item">
														<a href="" title="" target="_self" id="" class="btn btn-default btn-block " type="button">
															<span class="btn-text">DEFAULT</span>
														</a>
														<a href="" title="" target="_self" id="" class="btn btn-primary btn-block " type="button">
															<span class="btn-text">PRIMARY</span>
														</a>
														<a href="" title="" target="_self" id="" class="btn btn-info btn-block " type="button">
															<span class="btn-text">INFO</span>
														</a>
														<a href="" title="" target="_self" id="" class="btn btn-success btn-block " type="button">
															<span class="btn-text">SUCCESS</span>
														</a>
														<a href="" title="" target="_self" id="" class="btn btn-warning btn-block " type="button">
															<span class="btn-text">WARNING</span>
														</a>
														<a href="" title="" target="_self" id="" class="btn btn-danger btn-block " type="button">
