					...
					<div id="" class="col-md-9 partbox-header-informations">
						<div id="" class="row">
							...
							<div id="" class="col-md-12 partbox-header-title">
								<i class="fa fa-square-o partbox-header-title-icon"></i>
								<span class="partbox-header-title-text">FORM GROUP INNER</span>
							</div>
														...
														<div id="" class="box-invisible">
															<div id="" class="row ">
																...
																<div id="" class="col-md-12 info-content-body">
																	...
																	<p class="info-content-text"><span class="highlight">.form-group</span></p>
																	<p class="info-content-text"><span class="highlight">.form-group.form-group-inner</span></p>
																	<p class="info-content-text"><span class="highlight">.form-group-header</span></p>
																	<p class="info-content-text"><span class="highlight">.form-group-header-informations</span></p>
																	<p class="info-content-text"><span class="highlight">.form-group-header-title</span></p>
																	<p class="info-content-text"><span class="highlight">.form-group-header-title-icon</span></p>
																	<p class="info-content-text"><span class="highlight">.form-group-header-title-text</span></p>
																	<p class="info-content-text"><span class="highlight">.form-group-header-subtitle</span></p>
																	<p class="info-content-text"><span class="highlight">.form-group-header-controls</span></p>
																	<p class="info-content-text"><span class="highlight">.form-group-body</span></p>
																	<p class="info-content-text"><span class="highlight">.form-group-footer</span></p>
																</div>
