					...
					<div id="" class="col-md-9 partbox-header-informations">
						<div id="" class="row">
							...
							<div id="" class="col-md-12 partbox-header-title">
								<i class="fa fa-plus-square partbox-header-title-icon"></i>
								<span class="partbox-header-title-text">INPUT GROUPS</span>
							</div>
														...
														<div id="" class="box-invisible">
															<div id="" class="row ">
																...
																<div id="" class="col-md-12 info-content-body">
																	...
																	<p class="info-content-text"><span class="highlight">.input-group</span></p>
																	<p class="info-content-text"><span class="highlight">.input-group-addon</span></p>
																	<p class="info-content-text"><span class="highlight">.input-group-addon-icon</span></p>
																	<p class="info-content-text"><span class="highlight">.input-group-addon-text</span></p>
																	<p class="info-content-text"><span class="highlight">.input-group-btn</span></p>
																</div>
												...
												<div id="" class="row">
													...
													<div id="" class="col-md-9 form-group-header-informations">
														<div id="" class="row">
															...
															<div id="" class="col-md-12 form-group-header-title">
																<span class="form-group-header-title-text">INPUT GROUP - ICON + INPUT</span>
															</div>
													...
													<div id="" class="col-md-12 form-item">
														<div id="" class="row">
															...
															<div id="" class="col-md-12 form-item-informations">
																<div for="" class="form-item-title">LOREM IPSUM</div>
																<div id="" class="form-item-description">Dolor sit amet</div>
															</div>
															<div id="" class="col-md-12 form-item-inputs">
																<!-- input group start -->
																<div id="" class="input-group">
																	<span class="input-group-addon"><i class="fa fa-globe input-group-addon-icon"></i></span>
												...
												<div id="" class="row">
													...
													<div id="" class="col-md-9 form-group-header-informations">
														<div id="" class="row">
															...
															<div id="" class="col-md-12 form-group-header-title">
																<span class="form-group-header-title-text">INPUT GROUP - INPUT + ICON</span>
															</div>
												...
												<div id="" class="row">
													...
													<div id="" class="col-md-9 form-group-header-informations">
														<div id="" class="row">
															...
															<div id="" class="col-md-12 form-group-header-title">
																<span class="form-group-header-title-text">INPUT GROUP - BUTTON + INPUT</span>
															</div>
												...
												<div id="" class="row">
													...
													<div id="" class="col-md-9 form-group-header-informations">
														<div id="" class="row">
															...
															<div id="" class="col-md-12 form-group-header-title">
																<span class="form-group-header-title-text">INPUT GROUP - INPUT + BUTTON</span>
															</div>
