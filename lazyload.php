					...
					<div id="" class="col-md-9 partbox-header-informations">
						<div id="" class="row">
							...
							<div id="" class="col-md-12 partbox-header-title">
								<i class="fa fa-refresh partbox-header-title-icon"></i>
								<span class="partbox-header-title-text">LAZY LOAD</span>
							</div>
														...
														<div id="" class="box-invisible">
															<div id="" class="row ">
																...
																<div id="" class="col-md-12 info-content-body">
																	...
																	<p class="info-content-text"><span class="highlight">.img-lazy</span></p>
																	<p class="info-content-text title">EVENTS & METHODS</p>
																	<p class="info-content-text"><span class="highlight">$('selector').lazyload()</span></p>
																</div>
										...
										<div id="" class="row">
												...
												<div id="" class="row">
													...
													<div id="" class="col-md-9 form-group-header-informations">
														<div id="" class="row">
															...
															<div id="" class="col-md-12 form-group-header-title">
																<span class="form-group-header-title-text">LAZY LOAD</span>
															</div>
											...
											<div id="" class="col-md-12 form-group-body">
												<div id="" class="row">
													...
													<!-- form item start -->
													<div id="" class="col-md-4 form-item">
														<img data-src="img/empty/empty.jpg" title="" alt="" id="" class="img img-responsive img-lazy" />
													</div>
													<!-- form item end -->
													<!-- form item start -->
													<div id="" class="col-md-4 form-item">
...
<script src="js/content/lazyload.js"></script>
