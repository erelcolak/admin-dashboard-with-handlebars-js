					...
					<div id="" class="col-md-9 partbox-header-informations">
						<div id="" class="row">
							...
							<div id="" class="col-md-12 partbox-header-title">
								<i class="fa fa-mouse-pointer partbox-header-title-icon"></i>
								<span class="partbox-header-title-text">BUTTONS - BASICS</span>
							</div>
														...
														<div id="" class="box-invisible">
															<div id="" class="row ">
																...
																<div id="" class="col-md-12 info-content-body">
																	...
																	<p class="info-content-text"><span class="highlight">.btn</span></p>
																	...
																	<p class="info-content-text"><span class="highlight">$('.btn').on('click', function(e){ e.preventDefault(); })</span></p>
																</div>
												...
												<div id="" class="row">
													...
													<div id="" class="col-md-9 form-group-header-informations">
														<div id="" class="row">
															...
															<div id="" class="col-md-12 form-group-header-title">
																<span class="form-group-header-title-text">BUTTONS - BASICS</span>
															</div>
