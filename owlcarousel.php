					...
					<div id="" class="col-md-9 partbox-header-informations">
						<div id="" class="row">
							...
							<div id="" class="col-md-12 partbox-header-title">
								<i class="fa fa-sliders partbox-header-title-icon"></i>
								<span class="partbox-header-title-text">OWL CAROUSEL</span>
							</div>
														...
														<div id="" class="box-invisible">
															<div id="" class="row ">
																...
																<div id="" class="col-md-12 info-content-body">
																	...
																	<p class="info-content-text"><span class="highlight"></span></p>
																	<p class="info-content-text title">EVENTS & METHODS</p>
																</div>
										...
										<div id="" class="row">
												...
												<div id="" class="row">
													...
													<div id="" class="col-md-9 form-group-header-informations">
														<div id="" class="row">
															...
															<div id="" class="col-md-12 form-group-header-title">
																<span class="form-group-header-title-text">OWL CAROUSEL</span>
															</div>
											...
											<div id="" class="col-md-12 form-group-body">
												<div id="" class="row">
													...
													<!-- form item start -->
													<div id="" class="col-md-12 form-item owl-carousel owl-theme">
														<!-- card start -->
														<div id="" class="col-md-12 card">
																		...
																		<div class="row">
																			...
																			<div id="" class="col-md-12 card-header-cover">
																				<div id="" class="row">
																					...
																					<img data-src="img/bg/bg-abusiness.jpg" src="img/empty/empty.jpg" title="" alt="" id="" class="img img-responsive card-header-cover-image img-lazy" />
																			...
																			<div id="" class="col-md-12 card-header-title">
																				<div id="" class="row">
																					...
																					<div id="" class="col-md-12 card-title">LOREM IPSUM DOLOR SIT AMET</div>
																					<div id="" class="col-md-12 card-subtitle">Consectetur adipisicing elit, sed do eiusmod tempor</div>
																		...
																		<div class="row">
																			...
																			<div id="" class="col-md-12 card-header-cover">
																				<div id="" class="row">
																					...
																					<img data-src="img/bg/bg-business.jpg" src="img/empty/empty.jpg" title="" alt="" id="" class="img img-responsive card-header-cover-image img-lazy" />
...
<script src="js/content/owlcarousel.js"></script>
