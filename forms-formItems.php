					...
					<div id="" class="col-md-9 partbox-header-informations">
						<div id="" class="row">
							...
							<div id="" class="col-md-12 partbox-header-title">
								...
								<span class="partbox-header-title-text">FORM ITEMS</span>
							</div>
														...
														<div id="" class="box-invisible">
															<div id="" class="row ">
																...
																<div id="" class="col-md-12 info-content-body">
																	...
																	<p class="info-content-text"><span class="highlight">.form-item</span></p>
																	<p class="info-content-text"><span class="highlight">.form-item-informations</span></p>
																	<p class="info-content-text"><span class="highlight">.form-item-title</span></p>
																	<p class="info-content-text"><span class="highlight">.form-item-description</span></p>
																	<p class="info-content-text"><span class="highlight">.form-item-inputs</span></p>
																</div>
												...
												<div id="" class="row">
													...
													<div id="" class="col-md-9 form-group-header-informations">
														<div id="" class="row">
															...
															<div id="" class="col-md-12 form-group-header-title">
																<span class="form-group-header-title-text">FORM ITEMS - BLOCK</span>
															</div>
												...
												<div id="" class="row">
													...
													<div id="" class="col-md-9 form-group-header-informations">
														<div id="" class="row">
															...
															<div id="" class="col-md-12 form-group-header-title">
																<span class="form-group-header-title-text">FORM ITEMS - INLINE</span>
															</div>
