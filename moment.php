					...
					<div id="" class="col-md-9 partbox-header-informations">
						<div id="" class="row">
							...
							<div id="" class="col-md-12 partbox-header-title">
								<i class="fa fa-clock-o partbox-header-title-icon"></i>
								<span class="partbox-header-title-text">MOMENT JS</span>
							</div>
														...
														<div id="" class="box-invisible">
															<div id="" class="row ">
																...
																<div id="" class="col-md-12 info-content-body">
																	...
																	<p class="info-content-text"><span class="highlight">ASP.NET ile gönderilen Milisaniye'yi Formatlamak</span> <strong>/Date(miliseconds)/</strong> şeklinde gönderilen tarih milisaniye cinsindendir ve buradaki milisaniyeyi tarih'e çevirmeniz gerekir. Bunu yapabilmek için ise; <strong>moment(date).format('DD.MM.YYYY')</strong> şeklinde format metodunu kullanabilirsiniz.</p>
																	<p class="info-content-text"><span class="highlight">Formatlanmış veriyi sunucuya göndermek</span> <strong>19.06.2018</strong> şeklinde formatlanmış bir input değerini sunucuya gönderirken öncesinde elinizdeki verinin nasıl bir formata sahip olduğunu belirtmeniz gerekir; sonrasında ise onu sunucunun istediği formata sokmanız gerekir bunun için ise; <strong>moment( $('#input').find('input').val(), 'DD.MM.YYYY').format('YYYY-MM-DD');</strong> şeklinde metod kullanılır.</p>
																</div>
