					...
					<div id="" class="col-md-9 partbox-header-informations">
						<div id="" class="row">
							...
							<div id="" class="col-md-12 partbox-header-title">
								<i class="fa fa-clone partbox-header-title-icon"></i>
								<span class="partbox-header-title-text">FORM GROUP CONTAINER</span>
							</div>
														...
														<div id="" class="box-invisible">
															<div id="" class="row ">
																...
																<div id="" class="col-md-12 info-content-body">
																	...
																	<p class="info-content-text"><span class="highlight">.form-group-container</span></p>
																	<p class="info-content-text"><span class="highlight">.form-group-container-body</span></p>
																	<p class="info-content-text"><span class="highlight">.form-group-container-footer</span></p>
																</div>
