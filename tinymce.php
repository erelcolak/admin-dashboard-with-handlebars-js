					...
					<div id="" class="col-md-9 partbox-header-informations">
						<div id="" class="row">
							...
							<div id="" class="col-md-12 partbox-header-title">
								<i class="fa fa-font partbox-header-title-icon"></i>
								<span class="partbox-header-title-text">TINY MCE</span>
							</div>
												...
												<div id="" class="row">
													...
													<div id="" class="col-md-9 form-group-header-informations">
														<div id="" class="row">
															...
															<div id="" class="col-md-12 form-group-header-title">
																<span class="form-group-header-title-text">TINY MCE</span>
															</div>
													...
													<div id="" class="col-md-12 form-item">
														<div id="" class="row">
															...
															<div id="" class="col-md-12 form-item-inputs">
																<textarea id="textarea" name="" class="form-control " value="" placeholder="" rows="5"></textarea>
															</div>
...
<script src="js/content/tinymce.js"></script>
