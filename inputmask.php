					...
					<div id="" class="col-md-9 partbox-header-informations">
						<div id="" class="row">
							...
							<div id="" class="col-md-12 partbox-header-title">
								<i class="fa fa-asterisk partbox-header-title-icon"></i>
								<span class="partbox-header-title-text">INPUT MASK</span>
							</div>
										...
										<div id="" class="row">
												...
												<div id="" class="row">
													...
													<div id="" class="col-md-9 form-group-header-informations">
														<div id="" class="row">
															...
															<div id="" class="col-md-12 form-group-header-title">
																<span class="form-group-header-title-text">INPUT MASK - MONEY</span>
															</div>
											...
											<div id="" class="col-md-12 form-group-body">
												<div id="" class="row">
													...
													<!-- form item start -->
													<div id="inputMaskMoney" class="col-md-12 form-item">
														<div id="" class="row">

															<div id="" class="col-md-12 form-item-informations">
																<div for="" class="form-item-title">LOREM IPSUM DOLOR SIT AMET</div>
																<div id="" class="form-item-description">Consectetur adipisicing elit, sed do eiusmod tempor</div>
															</div>
										...
										<div id="" class="row">
												...
												<div id="" class="row">
													...
													<div id="" class="col-md-9 form-group-header-informations">
														<div id="" class="row">
															...
															<div id="" class="col-md-12 form-group-header-title">
																<span class="form-group-header-title-text">INPUT MASK - DECIMAL</span>
															</div>
											...
											<div id="" class="col-md-12 form-group-body">
												<div id="" class="row">
													...
													<!-- form item start -->
													<div id="inputMaskDecimal" class="col-md-12 form-item">
														<div id="" class="row">
										...
										<div id="" class="row">
												...
												<div id="" class="row">
													...
													<div id="" class="col-md-9 form-group-header-informations">
														<div id="" class="row">
															...
															<div id="" class="col-md-12 form-group-header-title">
																<span class="form-group-header-title-text">INPUT MASK - PHONE</span>
															</div>
											...
											<div id="" class="col-md-12 form-group-body">
												<div id="" class="row">
													...
													<!-- form item start -->
													<div id="inputMaskPhone" class="col-md-12 form-item">
														<div id="" class="row">
...
<script src="js/plugins/inputmask/js/jquery.inputmask.bundle.min.js"></script>
<!-- external scripts end -->
<!-- internal scripts start -->
<script src="js/content/inputmask.js"></script>
