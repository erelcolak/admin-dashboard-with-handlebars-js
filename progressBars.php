					...
					<div id="" class="col-md-9 partbox-header-informations">
						<div id="" class="row">
							...
							<div id="" class="col-md-12 partbox-header-title">
								<i class="fa fa-server partbox-header-title-icon"></i>
								<span class="partbox-header-title-text">PROGRESS BARS</span>
							</div>
														...
														<div id="" class="box-invisible">
															<div id="" class="row ">
																		...
																		<div id="" class="col-md-9 info-content-header-informations">
																			<div id="" class="row">
																				...
																				<div id="" class="col-md-12 info-content-header-title">
																					<i class="fa fa-info-cirle info-content-header-title-icon"></i>
																...
																<div id="" class="col-md-12 info-content-body">
																	...
																	<p class="info-content-text"><span class="highlight">.progress</span></p>
																	<p class="info-content-text"><span class="highlight">.progress-bar</span></p>
																	<p class="info-content-text"><span class="highlight">.progress-bar.progress-bar-primary</span></p>
																	<p class="info-content-text"><span class="highlight">.progress-bar.progress-bar-info</span></p>
																	<p class="info-content-text"><span class="highlight">.progress-bar.progress-bar-success</span></p>
																	<p class="info-content-text"><span class="highlight">.progress-bar.progress-bar-warning</span></p>
																	<p class="info-content-text"><span class="highlight">.progress-bar.progress-bar-danger</span></p>
																</div>
												...
												<div id="" class="row">
													...
													<div id="" class="col-md-9 form-group-header-informations">
														<div id="" class="row">
															...
															<div id="" class="col-md-12 form-group-header-title">
																<span class="form-group-header-title-text">PROGRESS BARS</span>
															</div>
												...
												<div id="" class="row">
													...
													<div id="" class="col-md-12 form-item">
														...
														<div id="" class="progress ">
															<div id="" class="progress-bar progress-bar-primary" role="progressbar" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100" style="width: 20%;">
																20%
															</div>
														</div>
														<!-- progress end -->
														<!-- progress start -->
														<div id="" class="progress ">
															<div id="" class="progress-bar progress-bar-info" role="progressbar" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100" style="width: 20%;">
																20%
															</div>
														</div>
														<!-- progress end -->
														<!-- progress start -->
														<div id="" class="progress ">
															<div id="" class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100" style="width: 20%;">
																20%
															</div>
														</div>
														<!-- progress end -->
														<!-- progress start -->
														<div id="" class="progress ">
															<div id="" class="progress-bar progress-bar-warning" role="progressbar" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100" style="width: 20%;">
																20%
															</div>
														</div>
														<!-- progress end -->
														<!-- progress start -->
														<div id="" class="progress ">
															<div id="" class="progress-bar progress-bar-danger" role="progressbar" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100" style="width: 20%;">
																20%
															</div>
														</div>
														<!-- progress end -->
