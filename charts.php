					...
					<div id="" class="col-md-9 partbox-header-informations">
						<div id="" class="row">
							...
							<div id="" class="col-md-12 partbox-header-title">
								...
								<span class="partbox-header-title-text">CHARTS</span>
							</div>
														...
														<div id="" class="box-invisible">
															<div id="" class="row ">
																...
																<div id="" class="col-md-12 info-content-body">
																	...
																	<p class="info-content-text"><span class="highlight">.chart-container</span></p>
																</div>
												...
												<div id="" class="row">
													...
													<div id="" class="col-md-9 form-group-header-informations">
														<div id="" class="row">
															...
															<div id="" class="col-md-12 form-group-header-title">
																<span class="form-group-header-title-text">CHARTS - LINE CHART</span>
															</div>
											...
											<div id="" class="col-md-12 form-group-body">
												<div id="" class="row">
													...
													<div id="" class="col-md-12 form-item chart-container">
														<canvas id="chartLine" width="16" height="5"></canvas>
													</div>
													<!-- chartLine end -->
										...
										<div id="" class="row">
												...
												<div id="" class="row">
													...
													<div id="" class="col-md-9 form-group-header-informations">
														<div id="" class="row">
															...
															<div id="" class="col-md-12 form-group-header-title">
																<span class="form-group-header-title-text">CHARTS - BAR CHART</span>
															</div>
											...
											<div id="" class="col-md-12 form-group-body">
												<div id="" class="row">
													...
													<!-- chartBar start -->
													<div id="" class="col-md-12 form-item chart-container">
														<canvas id="chartBar" width="16" height="5"></canvas>
													</div>
													<!-- chartBar end -->
										...
										<div id="" class="row">
												...
												<div id="" class="row">
													...
													<div id="" class="col-md-9 form-group-header-informations">
														<div id="" class="row">
															...
															<div id="" class="col-md-12 form-group-header-title">
																<span class="form-group-header-title-text">CHARTS - DOUGHNUT CHART</span>
															</div>
											...
											<div id="" class="col-md-12 form-group-body">
												<div id="" class="row">
													...
													<!-- chartDoughnut start -->
													<div id="" class="col-md-12 form-item chart-container">
														<canvas id="chartDoughnut" width="16" height="5"></canvas>
													</div>
													<!-- chartDoughnut end -->
										...
										<div id="" class="row">
												...
												<div id="" class="row">
													...
													<div id="" class="col-md-9 form-group-header-informations">
														<div id="" class="row">
															...
															<div id="" class="col-md-12 form-group-header-title">
																<span class="form-group-header-title-text">CHARTS - PIE CHART</span>
															</div>
											...
											<div id="" class="col-md-12 form-group-body">
												<div id="" class="row">
													...
													<!-- chartPie start -->
													<div id="" class="col-md-12 form-item chart-container">
														<canvas id="chartPie" width="16" height="5"></canvas>
													</div>
													<!-- chartPie end -->
...
<script src="js/content/charts.js"></script>
